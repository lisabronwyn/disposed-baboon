...
##Specifications
We are doing the exercises from this link for challenge #86 from GuildCrafts: https://github.com/GuildCrafts/web-development-js/issues/86 which is to omplete the basic algorithm scripting section here:
